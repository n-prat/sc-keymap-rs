//! https://github.com/J-F-Liu/lopdf/blob/master/examples/merge.rs
...
/// https://github.com/J-F-Liu/lopdf/blob/a0a15dce11f8a2bc92acdd453e3d43aa82feebd3/examples/extract_toc.rs#L12
// static IGNORE: &[&str] = &[
//     "Length",
//     "BBox",
//     "FormType",
...
///
/// https://github.com/J-F-Liu/lopdf/blob/a0a15dce11f8a2bc92acdd453e3d43aa82feebd3/examples/extract_toc.rs#L65
...
///
/// https://github.com/J-F-Liu/lopdf/blob/a0a15dce11f8a2bc92acdd453e3d43aa82feebd3/examples/extract_toc.rs#L86
// fn load_pdf<P: AsRef<Path>>(path: P) -> Result<Document, Error> {
//     Document::load_filtered(path, filter_func)
//         .map_err(|e| Error::new(ErrorKind::Other, e.to_string()))
// }

/// Load Document; basic unfiltered version
fn load_pdf<P: AsRef<Path>>(path: P) -> Result<Document, Error> {
    Document::load(path).map_err(|e| Error::new(ErrorKind::Other, e.to_string()))
}

pub(crate) fn merge(pdf_paths: Vec<PathBuf>) -> Result<(), Error> {
    // "0" is the layer; which means there will be no nesting
    let mut documents = vec![];
    for pdf_path in pdf_paths.iter() {
        documents.push((0, load_pdf(pdf_path)?));
    }
    ...
    if pages_object.is_none() {
        return Err(Error::new(ErrorKind::Other, "Pages root not found"));
    }
    ...
    if catalog_object.is_none() {
        return Err(Error::new(ErrorKind::Other, "Catalog root not found"));
    }
