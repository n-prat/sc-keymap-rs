//! Basic pdf parser
//! based on https://github.com/J-F-Liu/lopdf/blob/fbdb55b006bd9abb06a245c58d15a2124cb926b4/examples/extract_text.rs
//! NOTE: master version add support for encrypted files; but not yet on crates.io?
...
pub(crate) fn pdf_read(pdf_path: PathBuf, output_path: PathBuf) -> Result<(), PdfReadError> {
    let start_time = Instant::now();

    pdf2text(&pdf_path, &output_path, true).unwrap();
